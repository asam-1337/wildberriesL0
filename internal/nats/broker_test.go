...
import (
	...
	repository2 "github.com/asam-1337/wildberriesL0/internal/repository"
...
func TestBroker_Subscribe(t *testing.T) {
	...
	pool, err := repository2.NewPgxPool(context.Background(), pg)
	if err != nil {
		t.Fatal(err)
	}
	repo := repository2.NewOrdersRepository(pool)
